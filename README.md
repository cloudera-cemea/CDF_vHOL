...
2. To create your flow, click on the **CDF Workshop draft** and select (<img src="images/3_cdf_createnewdraft.png" alt="image" style="width:auto;height:30px;">) select the Target Project: **CDF Workshop** and name the flow substituting the **<userid>** with your username: **\<userid>-syslog-kafka-flow**
